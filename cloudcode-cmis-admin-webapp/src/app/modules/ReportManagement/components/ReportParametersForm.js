...
export function ReportParametersForm(props) {
    ...
    <form className="card card-custom card-stretch">
      ...
      <div className="card-header py-3">
        ...
        <div className="card-toolbar">
          ...
          <Link
            to="/client-records/client-records-table"
              ...
              <div className="col-sm-12 col-lg-8 col-md-12">
                {/* begin: Client Case Management Info */}
                  ...
                  >
                    ...
                    />
                    <Tab label="Family Inclusion Plan" icon={<PeopleIcon />} />
                    <Tab
                      label="Durable Solution Pathway"
                      icon={<DirectionsIcon />}
                    />
                  </Tabs>
                  <SwipeableViews
                  ...
                  >
                    ...
                    <TabContainer dir={theme.direction}>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-6">
                        <select name="durable_solution_id" className={`form-control form-control-lg form-control-solid`}>
